...
earlier retinal and optic nerve implants, such as the devices by companies like
the \textit{PRIMA system} by Pixium-vision or \textit{Orion} and
\textit{ARGUSII} (FDA-approved) by Cortigent. Cortical prostheses are
