...
The ARGUS II, a well-known retinal prosthesis, provides a form of artificial vision by stimulating the remaining retinal cells. However, the quality of vision achieved is far from natural. Patients often report seeing light spots (phosphenes) that can be used to form rudimentary shapes and detect motion but lack the detail and clarity of normal vision. The best visual acuity achieved by ARGUS II users is approximately 20/1260, which is significantly lower than the standard for legal blindness (20/200). This level of vision is often insufficient for detailed tasks such as reading or recognizing faces, which limits the functional applications of the device in daily life.
