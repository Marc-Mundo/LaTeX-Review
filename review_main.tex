...
\todo[inline]{Maybe add a functional schematic of a visual cortical prosthesis
      to illustrate the components and their interactions.}

% Diagram figure (inkscape)
\begin{figure*}[hbt!]
      \centering
      \includegraphics[width=0.7\textwidth]{imgs/block_diagram_vis_prost.png}
      \caption{Diagram of how a visual cortical prosthesis
            works.}\label{fig:schematic}
\end{figure*}
...
\begin{figure*}[htbp]
      \begin{tcolorbox}[
                  ...
                  colbacktitle=black!50, % Title background color
                  fonttitle=\bfseries,
                  sharp corners=all,
                  width=\textwidth
            ]
...
\todo[inline]{Add a caption and label to the summary box?}
...
\todo[inline]{Left off here last time.}
