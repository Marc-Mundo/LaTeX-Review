...
\usepackage{abstract}
\usepackage{titlesec}
\usepackage[backend=biber,style=apa]{biblatex}% Change style to apa
...
\fancypagestyle{firstpage}{
  ...
  \fancyhead[R]{\fontsize{9}{11}\selectfont \textbf{Systematic Review in Neuroscience} \\ NWI-BM059}
  \fancyfoot[L]{\fontsize{9}{11}\selectfont Radboud University}
  \fancyfoot[C]{\fontsize{9}{11}\selectfont \thepage\ of~\pageref{LastPage}}
  \fancyfoot[R]{\fontsize{9}{11}\selectfont June 2024}
  \renewcommand{\footrulewidth}{0.3pt}
}

\fancypagestyle{rest}{
  \fancyhf{}
  \fancyhead[L]{\fontsize{9}{11}\selectfont Systematic Review}
  \fancyhead[R]{\fontsize{9}{11}\selectfont State-of-the-Art in Visual Cortical Prostheses}
  \fancyfoot[L]{\fontsize{9}{11}\selectfont Radboud University}
  \fancyfoot[C]{\fontsize{9}{11}\selectfont \thepage\ of~\pageref{LastPage}}
  \fancyfoot[R]{\fontsize{9}{11}\selectfont June 2024}
  \renewcommand{\footrulewidth}{0.3pt}
...
% % Adjust the head height as suggested by fancyhdr
